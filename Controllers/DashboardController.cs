...
using Transaction = ExpenseTracker.Models.Domaiins.Transaction;
...
namespace ExpenseTracker.Controllers
{
    public class DashboardController : Controller
    {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            //Balance
            decimal BalanceINR = TotalIncome - TotalExpense;
            CultureInfo culture = CultureInfo.CreateSpecificCulture("en-IND");
            culture.NumberFormat.CurrencyNegativePattern = 1;
            //ViewBag.Balance = String.Format(culture,"{0:C0}", BalanceINR);
            ViewBag.Balance = BalanceINR.ToString("C0", CultureInfo.GetCultureInfo("en-IN"));
